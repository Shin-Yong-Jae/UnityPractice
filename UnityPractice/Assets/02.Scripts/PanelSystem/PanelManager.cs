...
public class PanelManager
{
    ...
    public static void RegistPanel(Type panelType, BasePanel panel)
    {
        ...
        {
#if UNITY_EDITOR
            Debug.LogWarning($"이미 등록된 패널입니다. panelType: {panelType}");
#endif
            return;
        }
    ...
    public static void UnRegistPanel(Type panelType)
    {
        ...
        {
#if UNITY_EDITOR
            Debug.LogWarning($"등록되지 않은 패널입니다. panelType: {panelType}");
#endif
            return;
        }
    ...
    public static T GetPanel<T>() where T : BasePanel
    {
        ...
        {
#if UNITY_EDITOR
            Debug.LogWarning($"패널 정보를 가져올 수 없습니다. panelType: {panelType}");
#endif
            return null;
        }
